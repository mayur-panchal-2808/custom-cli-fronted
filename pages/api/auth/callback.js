...
export default async function handler(req, res) {
  try {
    console.log("=== CALLBACK STARTED ===");
    console.log("=== DEBUG: Full request received on Vercel ===");
    console.log("METHOD:", req.method);
    console.log("HEADERS:", req.headers); // DEBUG LOG
    console.log("RAW URL:", req.url); // DEBUG LOG
    console.log("QUERY:", req.query);
    ...
    console.log("=== DEBUG: USERINFO STATUS ===", userInfoResp.status);
    ...
    // DEBUG ENV VARS
    console.log("EXPRESS URL:", process.env.EXPRESS_STORE_SESSION_URL);
    console.log("SECRET (exists?):", !!process.env.NEXTJS_TO_EXPRESS_SECRET);

    // Notify Express
    console.log("=== DEBUG: Sending request to EXPRESS backend ===");
    ...
    console.log("EXPRESS RESPONSE TEXT:", expressText);
